...
abstract class DVD implements Serializable, Rentable {
    ...
    public int getRentedCustomerId() {
        return rentedCustomerId;
    }
    
    public void setRentedCustomerId(int rentedCustomerId) {
    ...
    @Override
    public void rent(int customerId, int days) {
        setAvailable(false);
        setRentedCustomerId(customerId);
